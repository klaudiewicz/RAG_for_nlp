...
# --- 2. WARSTWA FILTRACJI I RERANKINGU ---
...
def temporal_reranker(docs, user_question):
    ...
    for doc in docs:
        # FIX: Upewnienie się, że istnieje klucz 'metadata' dla generate_answer_variant
        ...
        # Wywołanie LLM dla każdego chunka
    ...
    # Sortowanie malejąco po nowym score
...
def rag_with_temporal_logic(user_input):
    ...
    # 1. Retrieval
    # Używamy retrieve_adaptive, które zwraca listę dokumentów (sprawdź czy ma metadata!)
...
if __name__ == "__main__":
    ...
    # FIX: MOCKOWANIE DANYCH Z POPRAWNĄ STRUKTURĄ
    # Dodano klucz 'metadata', którego wymaga prompt.py
    mock_docs = [
        {
            "id": "doc_lstm", 
